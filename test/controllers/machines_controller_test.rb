...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { machine_name: @machine.machine_name } }, as: :json
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { machine_name: @machine.machine_name } }, as: :json
    assert_response 200
  end
